...
export default function MenuLogistik() {
        ...
        <div className="deznav">
            <div className="deznav-scroll">
                <ul className="metismenu" id="menu">
                    ...
                    <li className="menu-title">Inventaris</li>
                    ...
                    <li>
                        ...
                        <ul aria-expanded="false" id="master">
                            ...
                            {/* <li>
                                <Link href="/master/requesttugas">Request Tugas</Link>
                            </li> */}
                            <li>
                    ...
                    <li>
                        <a href="#master" className="has-arrow " aria-expanded="false">
                            ...
                            <span className="nav-text">Logistik</span>
                        </a>
                        <ul aria-expanded="false" id="master">
                            <li className="mini-dashboard">Logistik</li>
                            <li>
                                <Link href="/master/inventaris">Data Barang</Link>
                            </li>
                            <li>
                                <Link href="/master/peminjaman">Data Peminjaman Barang</Link>
                            </li>
